...
BBHodoDetector::BBHodoDetector( const char* name, const char* description,
...
//_____________________________________________________________________________
Int_t BBHodoDetector::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t BBHodoDetector::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
void BBHodoDetector::Clear( Option_t* opt )
{
...
//_____________________________________________________________________________
Int_t BBHodoDetector::Decode( const THaEvData& evdata )
{
  // Decode data.
  ...
  if (ldebug) cout << "Inside BBHodoDetector :: Decode().  Event num "<<evdata.GetEvNum()<<endl;
  ...
  for( Int_t i = 0; i < fDetMap->GetSize(); i++ ) {
    ...
    if (d->crate < 0 || d->crate > 20 || d->slot < 0 || d->slot>25) {
        cout << "BBHodoDetector: warning:  strange crate slot "<<d->crate<<"  "<<d->slot<<endl;
        continue;
...
//_____________________________________________________________________________
Int_t BBHodoDetector::CoarseProcess( TClonesArray& tracks )
{
...
//_____________________________________________________________________________
Int_t BBHodoDetector::FineProcess( TClonesArray& tracks )
{
...
//_____________________________________________________________________________
void BBHodoDetector::Print( Option_t* opt ) const
{
