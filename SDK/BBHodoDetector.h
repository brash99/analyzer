#ifndef ROOT_BBHodoDetector
#define ROOT_BBHodoDetector
...
class BBHodoDetector : public THaNonTrackingDetector {

public:
  BBHodoDetector( const char* name, const char* description = "",
		THaApparatus* a = NULL );
  BBHodoDetector() : fRawADC(0), fCorADC(0) {}
  virtual ~BBHodoDetector();
...
protected:
  ...
  ClassDef(BBHodoDetector,0)   // BigBite Hodoscope
};
